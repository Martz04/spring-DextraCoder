 ...
 <body ng-controller="SolutionController as solutionCtrl" ng-init="solutionCtrl.loadData()">
 	<section class="wrapper">
		<div class="page-header">
	  		<h1>Solved Problems<small>User: {{solutionCtrl.name}}</small></h1>
		</div>
		<table class="table">
			<thead>
				<tr>
			...
			<tbody>
				<tr ng-repeat="solution in solutionCtrl.tableData" ng-click="solutionCtrl.selectRow(solution.id)">
...
<!-- 	            <p>{{textCtrl.problemParam.problem.problemInputOutputs[0].output}}</p> -->
	        ...
	        <div class="column column-alt float-left grouping">
	          <div id="editor" class="panel panel-default"> {{solutionCtrl.selected.solution}} </div>
	    	</div>    
	      </div><!-- modal-body -->
